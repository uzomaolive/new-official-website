...
const WorkExperience: React.FC = () => {
  return (
    <section className="section4 flex flex-col w-full min-h-screen bg-[rgba(250,249,249,255)]">
      <h1
        className="font-bold text-[40px] roboto-mono leading-[57.65px] py-8 pl-[280px] pt-[150px] text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-indigo-400"
      >
        My Work Experience
      </h1>
        ...
        <div className="entry flex items-start gap-8 relative">
          ...
          <div className="w-3/4 pl-6 relative">
            ...
            <p className="leading-[2.25]">
              ...
              contributing to product development <br /> and testing, responding to inquiries and complaints,
        ...
        <div className="entry flex items-start gap-8 relative">
          ...
          <div className="w-3/4 pl-6 relative">
            ...
            <p className="leading-[2.25]">
              ...
              provide insights for progress, and design <br />various interfaces and wireframes,
